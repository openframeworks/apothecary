    ...
    if (ANGLE_APPLE_AVAILABLE_XI(10.15, 13.0))
    {
        ...
        switch (iOSFamily)
        {
            ...
            case 5:
                ...
                break;
#        if TARGET_OS_VISION || TARGET_OS_IOS || (TARGET_OS_OSX && (__MAC_OS_X_VERSION_MAX_ALLOWED >= 101600))
            case 6:
                family = MTLGPUFamilyApple6;
                break;
#        endif
#        if (TARGET_OS_VISION || TARGET_OS_IOS && (__IPHONE_OS_VERSION_MAX_ALLOWED >= 140000)) || \
