 ...
 * ownership.
 */
inline lwc_string* lwc_string_ref(lwc_string* str) {assert(str != NULL); str->refcnt++; return str;}
 ...
 */
inline enum lwc_error_e lwc_string_isequal(lwc_string * str1, lwc_string * str2, bool * ret) {
	return ((*(ret) = ((str1) == (str2))), lwc_error_ok);
}
 ...
 *	    not be valid.
 */
inline enum lwc_error_e lwc_string_caseless_isequal(lwc_string * str1, lwc_string * str2, bool * ret){
    lwc_error __lwc_err = lwc_error_ok;                         
    lwc_string *__lwc_str1 = (str1);                           
    lwc_string *__lwc_str2 = (str2);                           
    bool *__lwc_ret = (ret);                                   
 ...
 */
inline const char* lwc_string_data(lwc_string * str) {assert(str != NULL); return (const char *)((str)+1);}
 ...
 */
inline size_t lwc_string_length(lwc_string * str) {assert(str != NULL); return (str)->len;}
 ...
 */
inline lwc_hash lwc_string_hash_value(lwc_string * str) {assert(str != NULL); return (str)->hash;}
