...
function build() {
    if [ "$TYPE" == "linux" ] || [ "$TYPE" == "linux64" ] || [ "$TYPE" == "linuxarmv6l" ] || [ "$TYPE" == "linuxarmv7l" ] || [ "$TYPE" == "msys2" ] ; then
        ...
        LIBXML_ROOT="$LIBS_ROOT/libxml2/"
        LIBXML_INCLUDE_DIR="$LIBS_ROOT/libxml2/include"
        LIBXML_LIBRARY="$LIBS_ROOT/libxml2/lib/$TYPE/$PLATFORM/libxml2.lib"
		...
		if [ $VS_VER -eq 17 ]; then
	        ...
	        cmake .. ${DEFS} \
	            ...
	            -DLIBXML2_ROOT=$LIBXML_ROOT \
	            -DLIBXML2_INCLUDE_DIR=$LIBXML_INCLUDE_DIR \
