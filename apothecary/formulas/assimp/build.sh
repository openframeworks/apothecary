...
build_arch()
{
    ...
    export CFLAGS="-arch $1 -pipe -no-cpp-precomp -stdlib=$CPP_STD_LIB -isysroot $SDKROOT -$CPP_DEV_TARGET=$IOS_SDK_TARGET -I$SDKROOT/usr/include/ -fembed-bitcode"
    ...
    $XCODE_ROOT_DIR/Developer/usr/bin/make assimp -j 8 -l VERBOSE=1
