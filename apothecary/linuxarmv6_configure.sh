export PKG_CONFIG_PATH=$SYSROOT/usr/lib/$PREFIX/pkgconfig:$SYSROOT/usr/share/pkgconfig:$SYSROOT/usr/lib/pkgconfig
...
export LDFLAGS="--sysroot=${SYSROOT} -L$SYSROOT/usr/lib -L$SYSROOT/usr/lib/arm-linux-gnueabihf"
