...
export CFLAGS="--sysroot=${SYSROOT} -I$SYSROOT/lib/gcc/aarch64-linux-gnu/10.3.1 -march=armv8-a -mfpu=vfp -mfloat-abi=hard -fPIC -ftree-vectorize -Wno-psabi -pipe -DSTANDALONE -DPIC -D_REENTRANT -D_LARGEFILE64_SOURCE -D_FILE_OFFSET_BITS=64 -D__STDC_CONSTANT_MACROS -D__STDC_LIMIT_MACROS -DTARGET_POSIX -DHAVE_LIBOPENMAX=2 -DOMX -DOMX_SKIP64BIT -DUSE_EXTERNAL_OMX -DHAVE_LIBBCM_HOST -DUSE_EXTERNAL_LIBBCM_HOST -DUSE_VCHIQ_ARM"
export LDFLAGS="--sysroot=${SYSROOT} -L$SYSROOT/aarch64-linux-gnu/lib64 -lm"
