...
if(ANDROID_ABI STREQUAL "armeabi-v7a")
    ...
    set(CMAKE_C_FLAGS "-mfpu=neon -mfloat-abi=softfp -O3 -ffast-math -funroll-loops -funsafe-math-optimizations --target=${ANDROID_API} -D__ANDROID_API__=${ANDROID_API}")
    set(CMAKE_CXX_FLAGS "-mfpu=neon -mfloat-abi=softfp -O3 -ffast-math -funroll-loops -funsafe-math-optimizations -fexceptions -frtti --target=${ANDROID_API} -D__ANDROID_API__=${ANDROID_API}")
elseif(ANDROID_ABI STREQUAL "arm64-v8a")
    ...
    set(CMAKE_C_FLAGS "-O3 -ffast-math -funroll-loops -funsafe-math-optimizations --target=${ANDROID_API} -D__ANDROID_API__=${ANDROID_API}")
    set(CMAKE_CXX_FLAGS "-O3 -fexceptions -frtti -ffast-math -funroll-loops -funsafe-math-optimizations --target=${ANDROID_API} -D__ANDROID_API__=${ANDROID_API}")
elseif(ANDROID_ABI STREQUAL "x86")
    set(MACHINE "i686")
    set(ANDROID_PREFIX "i686-linux-android")
    set(ANDROID_TARGET "i686-none-linux-android${ANDROID_NATIVE_API_LEVEL}")
    set(CMAKE_SYSTEM_PROCESSOR "i686")
    set(CMAKE_C_FLAGS "-O3 --target=${ANDROID_API} -D__ANDROID_API__=${ANDROID_API}")
    set(CMAKE_CXX_FLAGS "-O3 -fexceptions -frtti --target=${ANDROID_API} -D__ANDROID_API__=${ANDROID_API}")
